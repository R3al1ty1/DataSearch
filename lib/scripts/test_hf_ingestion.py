...
async def test_hf_ingestion():
    """Test HuggingFace dataset ingestion and verify what gets saved to DB."""

    logger = container.logger
    logger.info("=== Testing HuggingFace Dataset Ingestion ===")
    ...
    async with container.db._session_factory() as session:
        try:
            ...
            logger.info(f"HuggingFace datasets before: {total_before}")
